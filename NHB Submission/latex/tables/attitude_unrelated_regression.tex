...
\begin{table}[!t]
\caption{Regressions of attitude measures on losing in task 1, being paired with the messenger, and their interaction in the unrelated fate condition (including demographic controls)}
\begin{center}
\scalebox{0.8}{
